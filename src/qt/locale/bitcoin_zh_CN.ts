...
<translation>
<numerusform>到四叶币网络的连接共有%n条</numerusform>
</translation>
</message>
<message>
<location line="+22"/>
...
<translation>
该交易的字节数超标。您可以选择支付%1的交易费给处理您的交易的网络节点，有助于四叶币网络的运行。您愿意支付这笔交易费用吗？
</translation>
</message>
<message>
<location line="-140"/>
...
<translation>日期: %1 金额: %2 类别: %3 地址: %4</translation>
</message>
<message>
<location line="+33"/>
<location line="+23"/>
...
<translation>
现在显示的消息可能是过期的. 在连接上四叶币网络节点后，您的钱包将自动与网络同步，但是这个过程还没有完成.
</translation>
</message>
<message>
<location line="-124"/>
...
<translation>
错误: 交易被拒绝. 如果您使用的是备份钱包，可能存在两个钱包不同步的情况，另一个钱包中的四叶币已经被使用，但本地的这个钱包尚没有记录。
</translation>
</message>
</context>
<context>
...
<translation>
新挖出的四叶币必须等确120个确认才能使用。您生产出的数据块，将被广播到全网并添加到数据块链。如果入链失败，状态将变为“未被接受”，意味着您的数据块竞争失败，挖出的四叶币将不能使用。当某个节点先于你几秒生产出新的数据块，这种情况会偶尔发生。
</translation>
</message>
<message>
<location line="+7"/>
...
<translation>发送命令到服务器或者 leafcoind</translation>
</message>
<message>
<location line="-23"/>
...
<translation>指定配置文件 (默认为 leafcoin.conf)</translation>
</message>
<message>
<location line="+3"/>
<source>Specify pid file (default: leafcoind.pid)</source>
<translation>指定 pid 文件 (默认为 leafcoind.pid)</translation>
</message>
<message>
<location line="-1"/>
...
<translation>
%s, 您必须在配置文件设置rpcpassword: %s 建议您使用下面的随机密码: rpcuser=leafcoinrpc rpcpassword=%s (您无需记住此密码) 用户名和密码 必! 须! 不一样。 如果配置文件不存在，请自行建立一个只有所有者拥有只读权限的文件。 推荐您开启提示通知以便收到错误通知， 像这样: alertnotify=echo %%s | mail -s "Leafcoin Alert" admin@foo.com
</translation>
</message>
<message>
<location line="+17"/>
...
<translation>
错误：该交易被拒绝！发生这种错误的原因可能是：钱包中的四叶币已经被用掉，有可能您复制了wallet.dat钱包文件，然后用复制的钱包文件支付了四叶币，但是这个钱包文件中没有记录。
</translation>
</message>
<message>
<location line="+4"/>
...
<translation>
您必须在配置文件中加入选项 rpcpassword : %s 如果配置文件不存在，请新建，并将文件权限设置为仅允许文件所有者读取.
</translation>
</message>
</context>
</TS>