...
// Copyright (c) 2011-2012 Leafcoin Developers
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            ...
            Send(hSocket, strprintf("JOIN #leafcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #leafcoin%02d\r", channel_number).c_str());
        }
