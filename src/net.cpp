...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Leafcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.leafco.in", "seed.leafco.in"},
    {"seed2.leafco.in", "seed2.leafco.in"},
    {"seed3.leafco.in", "seed3.leafco.in"},
    {"seed4.leafco.in", "seed4.leafco.in"},
    {"seed5.leafco.in", "seed5.leafco.in"},
    {"seed6.leafco.in", "seed6.leafco.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Leafcoin is probably already running."), addrBind.ToString().c_str());
        else
